<html>
  <head>
    ...
    <title>Update Bio Content</title>
  </head>
        ...
        <div class="row" style="margin-top:2%">
          <div class="col l12 s12">
            <div class="card green darken-2">
              <?php echo form_open('Owner/updateContent'); ?>
                <div class="card-content">
                  <span class="card-title white-text">Update Bio ID : <?php echo $dataContent[0]->id ?></span>
                  <div class="row">
                    <div class="input-field col l6 s12 white-text">
                      ...
                      <input id="icon_prefix" type="text" class="validate" name="name" value="<?php echo $dataContent[0]->owner_name ?>">
                      <label for="icon_prefix" class="white-text">Nama</label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="input-field col l12 s12 white-text">
                      <i class="material-icons prefix">create</i>
                      <textarea id="textarea1" class="materialize-textarea" length="50" name="alamat"><?php echo $dataContent[0]->Alamat ?></textarea>
                      <label for="textarea1" class="white-text">Alamat</label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="input-field col l12 s12 white-text">
                      <i class="material-icons prefix">create</i>
                      <textarea id="textarea1" class="materialize-textarea" length="50" name="phone"><?php echo $dataContent[0]->Phone ?></textarea>
                      <label for="textarea1" class="white-text">Phone</label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="input-field col l12 s12 white-text">
                      <i class="material-icons prefix">create</i>
                      <textarea id="textarea1" class="materialize-textarea" length="50" name="tagline"><?php echo $dataContent[0]->tagline ?></textarea>
                      <label for="textarea1" class="white-text">Tagline</label>
                    </div>
                  </div>
                </div>
