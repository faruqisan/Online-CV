<html>
  <head>
    ...
    <title>Update Portofolio Content</title>
  </head>
        ...
        <div class="row" style="margin-top:2%">
          <div class="col l12 s12">
            <div class="card green darken-2">
              <?php echo form_open('Portofolio/saveUpdate'); ?>
                <div class="card-content">
                  <span class="card-title white-text">Update Portofolio ID : <?php echo $dataContent[0]->IDport ?></span>
                  <div class="row">
                    <div class="input-field col l6 s12 white-text">
                      <i class="material-icons prefix">account_circle</i>
                      <input id="icon_prefix" type="hidden" class="validate" name="id" value="<?php echo $dataContent[0]->IDport ?>">
                      <input id="icon_prefix" type="text" class="validate" name="title" value="<?php echo $dataContent[0]->judulKontenPort ?>">
